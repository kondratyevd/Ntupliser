...
samps.append(H2Mu_gg_125_powheg)
samps.append(H2Mu_VBF_125_powheg)
samps.append(ZJets_AMC)
samps.append(ZJets_AMC_hiStat)
samps.append(ZJets_MG_1)
samps.append(ZJets_MG_hiStat)
#samps.append(ZJets_VBFfilter)
...
for samp in samps:
    ...
    in_file = open('templates/crab_config_DK.py', 'r')
